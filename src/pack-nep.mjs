    ...
    choices: [
      {
        ...
        metrics: {economy: -4, unity: -12, social: 3, externalIndependence: 8, selfDetermination: -3, },
      ...
      },
      {
        ...
        metrics: {economy: 3, unity: 4, externalIndependence: 1, selfDetermination: 2, },
      ...
      },
      {
        ...
        metrics: {economy: 4, unity: -6, externalIndependence: -6, },
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        metrics: {unity: 6, social: -2, externalIndependence: -4, },
        setsFlags: { westernAlienation: 'moderate', energyModel: 'market' },
        approvalDelta: -1,
        isHistorical: false,
      },
    ...
    choices: [
      {
        ...
        metrics: {unity: 3, rights: 2, selfDetermination: 1, },
      ...
      },
      {
        ...
        metrics: {unity: 0, rights: 1, selfDetermination: 1, },
